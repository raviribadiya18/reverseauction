        ...
        <div class="container">
            <div class="text-content">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <p class="description">
                           "Reverse Auction" specializes in helping Charities, VWO'S, NGO's and Religious Organisations to maximise their fund raising efforts when these organisations are having a Fund Raising Dinner.
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <p class="description">
                           Craig uses "Reverse Auction" as an inclusive, engaging and fun way where people attending these Fund Raising Dinners enjoy the event and want to make a contribution.
                        </p>
                    </div>
                </div>
            </div>
